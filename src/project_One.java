...
//    InputStream fi = new FileInputStream("C:\Coding_Project\java_coding\lab1.1.1\realreal_lab1/test.txt");
...
//    findPathToOther("to");
        ...
        System.out.println("Save to the path C:\\Coding_Project\\java_coding\\lab1.1.1\\realreal_lab1/test.txt/2.txt:");
        try{
            File fo = new File("C:\\Coding_Project\\java_coding\\lab1.1.1\\realreal_lab1/test.txt/2.txt");
